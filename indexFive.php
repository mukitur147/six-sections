...
<body>
        <section>
            <div class=" relative items-center w-full  mx-auto max-w-7xl">
                ...
                <div class="flex flex-wrap items-end justify-start w-full bg-white ">
                  ...
                  <div class="w-full xl:w-1/4 md:w-1/4">
                    <div class="relative flex flex-col h-full p-8">
                      <h2 class="mb-4 text-sm font-medium tracking-widest text-neutral-600 uppercase"> Sponsorships </h2>
                      <ul class="space-y-4">
                        <li class="flex items-center mb-2 text-base font-medium leading-relaxed text-neutral-600">
                  ...
                  <div class="w-full xl:w-1/4 md:w-1/4 lg:ml-auto">
                    <div class="relative flex flex-col h-full p-8">
                      ...
                      <div class="mt-2">
                        <button  class="flex items-center justify-center w-full px-10 py-4 text-base font-medium text-center text-white transition duration-500 ease-in-out transform bg-blue-600 rounded-xl hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"> Buy Now </button>
                      </div>
